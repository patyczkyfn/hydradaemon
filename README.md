...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wfg9f4g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wfg9f4g.containers.anotherwebservice.com/
...
```
git clone git@github.com:patyczkyfn/hydradaemon.git
cd container-wfg9f4g
```
...
```
docker attach container-wfg9f4g
```
